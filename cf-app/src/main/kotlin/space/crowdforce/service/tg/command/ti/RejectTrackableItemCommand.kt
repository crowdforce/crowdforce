...
@Service
class RejectTrackableItemCommand(
    ...
    override fun execute(user: User, context: UserContext): CommandAnswer {
        ...
        trackableItemService.changeParticipantEventStatus(user.id, eventId, ConfirmationStatus.APPROVE_REJECTED)
    ...
    companion object {
        const val NAME = "reject_participation"
    }
}